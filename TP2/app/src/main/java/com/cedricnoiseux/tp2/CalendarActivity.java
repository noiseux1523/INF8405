...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityLayout.setBackgroundColor(Color.parseColor("#4cae2e"));
        ...
        mOutputText.setTextColor(Color.WHITE);
        ...
        mMenu = new TextView(this);
        mMenu.setTextSize(24);
        mMenu.setText("MENU");
        mMenu.setTextColor(Color.WHITE);
        mMenu.setGravity(Gravity.CENTER);
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            for (Event event : items) {
                ...
                if (start == null) {
                    ...
                    // the start date.start = event.getStart().getDate();
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                try {
                    ...
                    writer1.close();
                    reader1.close();
                    if (firstCreation && mCredential.getSelectedAccountName() != null) {
                        firstCreation = false;
                        Toast.makeText(getApplicationContext(), "You can now navigate through the menu.", Toast.LENGTH_LONG).show();
                        goToMenu();
                    }
                } catch (IOException e) {
                    e.printStackTrace();
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ((UserRecoverableAuthIOException) mLastError).getIntent(), CalendarActivity.REQUEST_AUTHORIZATION);
                } else {
